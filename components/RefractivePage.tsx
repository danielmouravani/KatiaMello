...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "O procedimento é extremamente rápido. A aplicação do laser leva apenas alguns segundos por olho, e o tempo total na sala cirúrgica costuma ser de 10 a 15 minutos.",
  },
  {
    question: "Vou sentir dor?",
    answer:
      "Não. A cirurgia é feita com colírios anestésicos. Você pode sentir uma leve pressão ou desconforto passageiro, mas não dor. No pós-operatório, pode haver sensação de areia nos olhos, que passa em poucos dias.",
  },
  {
    question: "A partir de que idade posso operar?",
    answer:
      "Geralmente a partir dos 18 ou 21 anos, desde que o grau esteja estabilizado há pelo menos um ano. É necessária uma avaliação completa para confirmar.",
  },
  {
    question: "É seguro? Existe risco de ficar cego?",
    answer:
      "A cirurgia refrativa é um dos procedimentos mais seguros e realizados do mundo. O laser é controlado por computador com altíssima precisão. O risco de complicações graves é extremamente baixo.",
  },
];
...
const STEPS = [
  {
    num: 1,
    title: "Avaliação pelo Especialista",
    desc: "Anamnese completa para entender seu caso.",
  },
  {
    num: 2,
    title: "Exames Completos",
    desc: "Incluindo topografia e tomografia da córnea.",
  },
  {
    num: 3,
    title: "Avaliação Pré-Operatória",
    desc: "Confirmação da técnica ideal (Lasik ou PRK).",
  },
  {
    num: 4,
    title: "Procedimento Cirúrgico",
    desc: "Rápido, seguro e com tecnologia a laser.",
  },
  { num: 5, title: "Pós-Operatório", desc: "Acompanhamento da cicatrização." },
  {
    num: 6,
    title: "Alta do Paciente",
    desc: "Liberdade para enxergar o mundo.",
  },
];
...
const RefractivePage: React.FC<RefractivePageProps> = ({ onNavigate }) => {
  ...
  return (
    <div
      id="refrativa"
      className="bg-white min-h-screen pt-20 animate-fade-in-up font-sans"
    >
      {/* 1. HERO CONVERSÃO */}
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-1/2 space-y-6">
              <div className="inline-flex items-center gap-2 bg-blue-500/20 border border-blue-400/30 px-4 py-1.5 rounded-full text-blue-300 text-sm font-bold uppercase tracking-wide">
                <Zap size={16} className="text-yellow-400" /> Tecnologia 100% a
                Laser
              </div>

              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold leading-tight">
                Liberte-se dos Óculos e{" "}
              ...
              <p className="text-lg text-slate-300 leading-relaxed max-w-lg">
                Corrija Miopia, Hipermetropia e Astigmatismo. Procedimento
                rápido, recuperação ágil e a segurança que seus olhos merecem.
              </p>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              Mais do que estética, é sobre qualidade de vida e praticidade no
              seu dia a dia.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="border border-slate-100 rounded-3xl p-8 shadow-lg shadow-slate-200/50 hover:border-brand-200 transition-all text-center group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-4">
                Visão sem óculos ou lentes
              </h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                Um dos maiores benefícios é a liberdade de não depender mais de
                correção visual para acordar, tomar banho ou enxergar o
                despertador.
              </p>
            </div>
            ...
            <div className="border border-slate-100 rounded-3xl p-8 shadow-lg shadow-slate-200/50 hover:border-brand-200 transition-all text-center group">
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                A maioria dos pacientes retorna às atividades normais em poucos
                dias. A técnica Lasik permite recuperação visual quase imediata.
              </p>
            </div>
            ...
            <div className="border border-slate-100 rounded-3xl p-8 shadow-lg shadow-slate-200/50 hover:border-brand-200 transition-all text-center group">
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                Conforto para praticar esportes, ir à praia, usar óculos escuros
                comuns e fim do embaçamento com máscaras ou ar condicionado.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <h2 className="text-brand-600 font-bold tracking-wider uppercase text-sm mb-2">
              Tecnologias
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-3xl p-8 border-2 border-transparent hover:border-blue-400 shadow-xl transition-all">
              ...
              <p className="text-slate-600 text-sm leading-relaxed text-justify">
                Esse é o procedimento mais moderno, habitualmente indicado para
                pessoas com miopia, hipermetropia e astigmatismo. O Lasik
                consiste na criação de um "flap" (uma fina camada) na córnea,
                aplicação do laser na camada interna e reposicionamento do flap.
              </p>
              <div className="mt-6 space-y-3 bg-blue-50/50 p-4 rounded-xl">
                <p className="text-sm text-slate-700 flex items-center gap-2">
                  <CheckCircle2 size={16} className="text-green-500" />{" "}
                  <strong>Pós-operatório:</strong> Tranquilo e indolor.
                </p>
                <p className="text-sm text-slate-700 flex items-center gap-2">
                  <CheckCircle2 size={16} className="text-green-500" />{" "}
                  <strong>Recuperação:</strong> Rápida (1 a 2 dias).
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 border-2 border-transparent hover:border-blue-400 shadow-xl transition-all">
              ...
              <p className="text-slate-600 text-sm leading-relaxed text-justify">
                Técnica onde o laser é aplicado diretamente na superfície da
                córnea, sem cortes (sem flap). É indicada para córneas mais
                finas ou esportistas de contato. No pós-operatório é utilizada
                uma lente de contato terapêutica temporária.
              </p>
              <div className="mt-6 space-y-3 bg-blue-50/50 p-4 rounded-xl">
                <p className="text-sm text-slate-700 flex items-center gap-2">
                  <CheckCircle2 size={16} className="text-green-500" />{" "}
                  <strong>Indicação:</strong> Córneas finas.
                </p>
                <p className="text-sm text-slate-700 flex items-center gap-2">
                  <CheckCircle2 size={16} className="text-green-500" />{" "}
                  <strong>Recuperação:</strong> Gradual (aprox. 1 semana).
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 text-center text-sm text-slate-500 max-w-3xl mx-auto">
            <p>
              Em ambos os procedimentos a anestesia é tópica (colírios). O
              melhor procedimento para o seu caso deve ser avaliado e decidido
              pelo especialista através de exames precisos.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="lg:w-1/2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {STEPS.map((step) => (
                  <div
                    key={step.num}
                    className="bg-brand-500 text-white p-6 rounded-2xl relative overflow-hidden group hover:scale-105 transition-transform duration-300 shadow-lg"
                  >
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-slate-900 aspect-[9/16] max-w-sm mx-auto border-4 border-slate-100">
                ...
                <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/80 to-transparent p-6 text-white">
                  ...
                  <p className="text-xs text-slate-300">
                    Especialista em Córnea e Refrativa
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-brand-600 rounded-3xl p-8 md:p-16 text-center text-white relative overflow-hidden shadow-2xl">
            <div className="relative z-10 max-w-2xl mx-auto space-y-8">
              ...
              <p className="text-blue-100 text-lg">
                Agende sua avaliação e descubra se você é candidato à cirurgia
                refrativa.
              </p>
              <a
                href={WHATSAPP_LINK}
